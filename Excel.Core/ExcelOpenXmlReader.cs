...
namespace Excel
{
	...
	public class ExcelOpenXmlReader : IExcelDataReader
	{
		...
		public async Task<Workbook> ReadAll()
		{
			var datasetHelper = new DatasetHelper();
			await portable.LoadDataSetAsync(datasetHelper, true);
			return datasetHelper.Workbook;
		}
		...
		public async Task Initialize(System.IO.Stream fileStream)
		{
			await portable.InitializeAsync(fileStream);
		}
