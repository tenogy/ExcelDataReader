...
namespace ExcelDataReader.Portable
{
	...
	public class ExcelOpenXmlReader : IExcelDataReader
	{
		...
		public ExcelOpenXmlReader(IFileHelper fileHelper, IDataHelper dataHelper)
		{
		...
		{
			_zipWorker = new ZipWorker(fileHelper);
		...
		public async Task<bool> Read()
		{
			...
			if (_isFirstRead)
			{
				var initializeSheetRead = await InitializeSheetReadAsync();
